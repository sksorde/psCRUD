...
employeeController.update = function (req, res) {
    Employee.findByIdAndUpdate(req.params.id, { $set: { raisedby: req.body.raisedby, address: req.body.location, teamleader: req.body.teamleader, team: req.body.team } }, { new: true }, function (err, employee) {
        if (err) {
            console.log(err);
